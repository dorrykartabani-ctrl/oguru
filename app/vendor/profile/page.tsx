      ...
      <aside className="hidden md:flex flex-col h-screen fixed left-0 top-0 p-4 bg-surface-container-low border-r border-outline-variant w-64 z-40">
        ...
        <div className="mt-auto pt-6 border-t border-outline-variant">
          <button
            ...
            className="w-full flex items-center gap-3 px-2 mb-3 bg-secondary-container/40 rounded-lg p-2"
          >
            ...
            <div className="overflow-hidden text-left">
              ...
              <p className="text-xs text-on-surface-variant truncate">Current</p>
            </div>
          </button>
          <button
      ...
      <div className="md:ml-64 pt-20 md:pt-8 px-4 md:px-8 lg:px-12 max-w-5xl mx-auto">
        ...
        <div className="mb-6">
          {business.cover_url ? (
            ...
            <div className="h-48 md:h-64 rounded-2xl bg-gradient-to-br from-primary/20 to-secondary-container/40 flex items-center justify-center mb-4">
              <Camera size={40} className="text-on-surface-variant/40" />
            </div>
          )}
          ...
          <div className="flex items-start gap-4">
            {/* Logo or Chip */}
            <div className="flex-shrink-0 -mt-12 md:-mt-16 relative z-10">
              {business.logo_url ? (
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border-4 border-surface bg-surface shadow-organic-md">
                  <img
                ...
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl border-4 border-surface bg-surface flex items-center justify-center shadow-organic-md">
                  <div
                    className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center"
                    style={{ backgroundColor: chipColor }}
                  >
                    <ChipIcon size={32} className="text-white" />
                  </div>
                </div>
              )}
            </div>
              ...
              {business.business_types.length > 0 && (
                <div className="flex flex-wrap gap-1.5 mt-2">
                  {business.business_types.map((type) => (
                    <span
                      key={type}
                      className="inline-block px-2 py-0.5 bg-primary/10 text-primary text-xs font-label font-semibold uppercase tracking-wider rounded-full"
                    >
                      {type}
                    </span>
                  ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5">
          ...
          <Section
            icon={FileText}
            title="About"
            isComplete={isAboutComplete}
            editHref="/vendor/profile/about"
          >
                ...
                {DAYS.map((day) => {
                  ...
                  return (
                    <div key={day.value} className="flex items-center justify-between text-sm">
                      <span className="font-medium text-on-surface w-16">
                        {day.short}
                      </span>
                      <span
                        className={
          ...
          <Section
            ...
            editHref="/vendor/profile/keywords"
          >
            {keywords.length > 0 ? (
          ...
          <Section
            ...
            title="Social & Web"
            isComplete={true}
            editHref="/vendor/profile/social"
          >
            {hasSocial ? (
              <div className="space-y-2">
              ...
              <p className="text-sm text-on-surface-variant italic">
                No social links added (optional)
              </p>
            )}
          </Section>
        </div>
        ...
        {/* Menu Preview */}
        <section className="mt-4 md:mt-5 bg-surface-container-lowest border border-outline-variant rounded-2xl overflow-hidden">
          <div className="flex items-center justify-between p-4 md:p-5 border-b border-outline-variant">
            <div className="flex items-center gap-3">
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${
              ...
              <div>
                <h3 className="font-display font-semibold text-on-surface">Menu</h3>
                <p className="text-xs text-on-surface-variant flex items-center gap-1">
                  {products.length > 0 ? (
                    <>
                      <Check size={12} className="text-primary" />
          ...
          <div className="p-4 md:p-5">
            {products.length > 0 ? (
              ...
              <p className="text-sm text-on-surface-variant italic">
                Add products to your menu to start receiving orders
              </p>
            )}
          </div>
        </section>
        ...
        <p className="text-center text-xs text-on-surface-variant mt-8">
          This is a preview of your public profile · Customers will see these details
        </p>
      </div>
