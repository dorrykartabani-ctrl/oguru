    ...
    <main className="min-h-screen bg-surface text-on-surface pb-24 md:pb-8">
      ...
      <div className="md:ml-64 pt-20 md:pt-8 px-4 md:px-8 lg:px-12 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5">
          <Section icon={Camera} title="Photos & Identity" isComplete={isPhotosComplete} editHref="/vendor/profile/photos">
            <div className="grid grid-cols-3 gap-2">
              <div>
                <p className="text-[10px] font-label font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Logo</p>
                {business.logo_url ? (
              ...
              <div>
                <p className="text-[10px] font-label font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Cover</p>
                {business.cover_url ? (
                  <div className="aspect-square rounded-lg overflow-hidden bg-surface-container">
              ...
              <div>
                <p className="text-[10px] font-label font-semibold text-on-surface-variant uppercase tracking-wider mb-1">Chip</p>
                <div className="aspect-square rounded-lg bg-surface-container flex items-center justify-center">
          ...
          <Section icon={FileText} title="About" isComplete={isAboutComplete} editHref="/vendor/profile/about">
            {business.tagline || business.description ? (
              ...
              <p className="text-sm text-on-surface-variant italic">Add a tagline and description</p>
            )}
          </Section>
          ...
          <Section icon={MapPin} title="Location" isComplete={!!location} editHref="/vendor/profile/address">
            {location ? (
              <div className="space-y-1">
                ...
                <p className="text-sm text-on-surface-variant">{location.city}, {location.postcode}</p>
            ...
            {keywords.length > 0 ? (
              <div className="space-y-3">
                {Object.entries(keywordsByCategory).map(([category, kws]) => (
                  <div key={category}>
                    <p className="text-[10px] font-label font-semibold text-on-surface-variant uppercase tracking-wider mb-1.5">{category}</p>
                    <div className="flex flex-wrap gap-1.5">
                      {kws.map((kw) => (
                        <span key={kw.id} className="inline-block px-2 py-0.5 bg-primary/10 text-primary text-xs font-label font-semibold rounded-full">
                          {kw.keyword}
                        </span>
                      ))}
                    </div>
            ...
            {hasSocial ? (
              <div className="space-y-2">
                {business.instagram_handle && (
                  <a href={`https://instagram.com/${business.instagram_handle}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-on-surface hover:text-primary transition-colors group">
                ...
                {business.facebook_url && (
                  <a href={business.facebook_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-on-surface hover:text-primary transition-colors group">
                ...
                {business.tiktok_handle && (
                  <a href={`https://tiktok.com/@${business.tiktok_handle}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-on-surface hover:text-primary transition-colors group">
                ...
                {business.website_url && (
                  <a href={business.website_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-on-surface hover:text-primary transition-colors group">
                ...
                {business.google_business_url && (
                  <a href={business.google_business_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-on-surface hover:text-primary transition-colors group">
